...
public:
    ...
    sensor_range() : range_min_(0.1), range_max_(3.0), stop_range_(0.3), stopped_(false)
    {
        ...
        scan_sub_ = n_.subscribe<sensor_msgs::LaserScan>("/scan", 1000, &sensor_range::scanCallback, this);
    }
